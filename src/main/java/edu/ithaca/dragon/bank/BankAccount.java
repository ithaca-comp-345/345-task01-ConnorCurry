...
public class BankAccount {
    ...
    /**
     * @post adds amount to balance property
    ...
    /**
     * @post transfers money from one account to another
     * @param accountFrom account to take money from
     * @param accountTo account to transfer money to
